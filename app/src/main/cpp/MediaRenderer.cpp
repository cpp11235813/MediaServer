...
// Function to initialize JNI callback variables (should be called from JNI)
extern "C" JNIEXPORT void JNICALL
Java_com_github_mediaserver_DMSService_initJniCallback(JNIEnv *env, jclass clazz) {
    env->GetJavaVM(&g_vm);
    g_callbackClass = (jclass)env->NewGlobalRef(clazz);
    g_callbackMethod = env->GetStaticMethodID(clazz, "onMediaActionCallback", "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
}
